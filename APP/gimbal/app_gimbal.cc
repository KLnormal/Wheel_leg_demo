...
void app_gimbal_task(void *args) {
    ...
    while(true) {
        ...
        bsp_uart_printf(E_UART_DEBUG,"%f,%f,%f,%f,%f,%f\n",left_leg.my_status_space_.theta,left_leg.my_status_space_.dot_theta,
            left_leg.my_status_space_.distance_x,left_leg.my_status_space_.dot_distance_x,left_leg.my_status_space_.phi,left_leg.my_status_space_.phi_dot);
